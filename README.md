...
What Problem It Solves Lack of unified emergency response: Fragmented communication between civilians, police, and medical services.
...
Who It’s For Civilians seeking real‑time safety information and emergency reporting.
...
Key Features Biometric & Manual Authentication: Secure, multi‑method login using fingerprint/facial recognition or credentials.
...
🛠️ Tech Stack Technology Purpose React Frontend framework TypeScript Type‑safe development Tailwind CSS Utility‑first styling Vite Build tool and dev server Lucide React Icon library Vercel Deployment and hosting Gemini API AI‑powered image/incident analysis Custom Backend (Planned) Node.js + MongoDB for data

📁 Project Structure text src/ ├── components/
...
🔐 Authentication Flow Biometric Scan: Simulated fingerprint/facial recognition with RSA‑themed UI.
...
🚨 Incident Management Types: SOS, Crime, Medical, Fire, Danger.
...
🗺️ Safety Mapping Location Types: Police stations, hospitals, safe hubs, danger zones.
